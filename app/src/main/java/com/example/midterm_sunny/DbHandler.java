...
public class DbHandler extends SQLiteOpenHelper {
    ...
    //adding new record
    void insertUserDetails(String name, String college, String department) {
        ...
        cValues.put(KEY_COLLEGE, college);
    ...
    public ArrayList<HashMap<String, String>> GetUsers() {
        ...
        String query = "SELECT name, college, department FROM " + TABLE_Users;
        Cursor cursor = db.rawQuery(query, null);
        while (cursor.moveToNext()) {
            HashMap<String, String> user = new HashMap<>();
            //user.put("id", cursor.getString(cursor.getColumnIndex(KEY_ID)));
            user.put("name", cursor.getString(cursor.getColumnIndex(KEY_NAME)));
            user.put("college", cursor.getString(cursor.getColumnIndex(KEY_COLLEGE)));
